	...
	<section>
		<form action="insertar.php?type=<?php echo $type ?>" method="post">
			...
			<fieldset>
				...
				<input type="date" name="fecha_licencia" id="fecha_licencia" size="8"><br>

				<label for="facultad">Facultad: </label>
				<input type="text" name="facultad" id="facultad" size="20" maxlength="20"><br>

				<label for="tarifa">Tarifa: </label>
				<input type="text" name="tarifa" id="tarifa" size="10">
			</fieldset>
